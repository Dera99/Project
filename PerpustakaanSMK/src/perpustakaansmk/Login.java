...
public void login(){
        try {
            ...
            String sql = "SELECT * FROM user WHERE Username = '"+user.getText()+
            ...
            if (rs.next())
            {
                ...
                if (pass.equals(pass) && user.equals(user)){
                    ...
                    if(status.equals("Pustakawan") || status.equals("pustakawan")){
                        petugas_menu mu=new petugas_menu();
                        mu.setVisible(true);
                        dispose();
                    }
                    else if(status.equals("Admin") || status.equals("admin")){
                        petugas_menu mu=new petugas_menu();
                        mu.setVisible(true);
                        dispose();
                    }
