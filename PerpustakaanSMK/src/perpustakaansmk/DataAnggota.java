...
public class DataAnggota extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hapusperm = new javax.swing.JButton();
        ...
        hapusperm.setText("Hapus Permanen");
        hapusperm.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hapuspermActionPerformed(evt);
            }
        });
    ...
    private void hapuspermActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapuspermActionPerformed
        try{
            stt = CC.createStatement();
            stt.executeUpdate("DELETE FROM laporananggota WHERE noanggota = " + id);
            stt = CC.createStatement();
    ...
    }//GEN-LAST:event_hapuspermActionPerformed

    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        // TODO add your handling code here:
        DefaultTableModel table = (DefaultTableModel)dataanggota.getModel();
        String Search = jTextField1.getText();
        TableRowSorter<DefaultTableModel> tr = new TableRowSorter<DefaultTableModel>(table);
        dataanggota.setRowSorter(tr);
    ...
    private javax.swing.JButton hapusperm;
